...
namespace WpfApp1.Pages
{
    public partial class MovementHistoryPage : Page
    {
        ...
        private void BtnAdd_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (fromId == toId)
            {
                MessageBox.Show("отрудник, передающий оборудование, и принимающий не могут совпадать.", "Логическая ошибка", MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }
            ...
            try
            {
                ...
                if (eq != null)
                {
                    ...
                    if (!string.IsNullOrWhiteSpace(txtNewLocation.Text))
                        eq.Location = txtNewLocation.Text.Trim();
                }
